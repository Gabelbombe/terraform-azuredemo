...
In your text editor of choice (Visual Studio Code/Sublime/Vim/etc), create a file called `terraform_azure101.tf`. The exact name of the file is not important, since terraform accepts the folder name as a parameter - all scripts in the folder get executed. Paste the following code in that new file:
